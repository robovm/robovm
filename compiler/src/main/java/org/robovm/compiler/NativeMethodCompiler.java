...
public class NativeMethodCompiler extends AbstractMethodCompiler {
    ...
    private FunctionRef createNative(ModuleBuilder mb, SootMethod method) {
        ...
        /*
         * Generate a function which calls _bcResolveNative() on the first
         * invocation. _bcResolveNative() will resolve the JNI function or throw
         * an exception. The JNI function pointer is cached for subsequent
         * invocations.
         */
