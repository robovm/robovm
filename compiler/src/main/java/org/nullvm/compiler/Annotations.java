...
public class Annotations {
    public static final String BRIDGE = "Lorg/nullvm/rt/bro/annotation/Bridge;";
    public static final String CALLBACK = "Lorg/nullvm/rt/bro/annotation/Callback;";
    public static final String STRUCT_MEMBER = "Lorg/nullvm/rt/bro/annotation/StructMember;";
    public static final String STRUCT_RET = "Lorg/nullvm/rt/bro/annotation/StructRet;";
    public static final String POINTER = "Lorg/nullvm/rt/bro/annotation/Pointer;";
