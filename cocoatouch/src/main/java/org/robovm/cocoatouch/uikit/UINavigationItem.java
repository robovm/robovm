...
@NativeClass public class /*<name>*/ UINavigationItem /*</name>*/ 
    ...
    @Bridge(symbol = "objc_msgSendSuper") private native static UIBarButtonItem objc_getBackBarButtonItemSuper(ObjCSuper __super__, Selector __cmd__);
    /**
    ...
    @Bridge(symbol = "objc_msgSendSuper") private native static boolean objc_isHidesBackButtonSuper(ObjCSuper __super__, Selector __cmd__);
    /**
    ...
    @Bridge(symbol = "objc_msgSendSuper") private native static UIBarButtonItem objc_getLeftBarButtonItemSuper(ObjCSuper __super__, Selector __cmd__);
    /**
    ...
    @Bridge(symbol = "objc_msgSendSuper") private native static NSArray objc_getLeftBarButtonItemsSuper(ObjCSuper __super__, Selector __cmd__);
    /**
    ...
    @Bridge(symbol = "objc_msgSendSuper") private native static boolean objc_isLeftItemsSupplementBackButtonSuper(ObjCSuper __super__, Selector __cmd__);
    /**
    ...
    @Bridge(symbol = "objc_msgSendSuper") private native static UIBarButtonItem objc_getRightBarButtonItemSuper(ObjCSuper __super__, Selector __cmd__);
    /**
    ...
    @Bridge(symbol = "objc_msgSendSuper") private native static NSArray objc_getRightBarButtonItemsSuper(ObjCSuper __super__, Selector __cmd__);
    /**
    ...
    @Bridge(symbol = "objc_msgSendSuper") private native static UIView objc_getTitleViewSuper(ObjCSuper __super__, Selector __cmd__);
    /**
    ...
    @Bridge(symbol = "objc_msgSendSuper") private native static void objc_setHidesBackButtonSuper(ObjCSuper __super__, Selector __cmd__, boolean hidesBackButton, boolean animated);
    /**
    ...
    @Bridge(symbol = "objc_msgSendSuper") private native static void objc_setLeftBarButtonItemSuper(ObjCSuper __super__, Selector __cmd__, UIBarButtonItem item, boolean animated);
    /**
    ...
    @Bridge(symbol = "objc_msgSendSuper") private native static void objc_setLeftBarButtonItemsSuper(ObjCSuper __super__, Selector __cmd__, NSArray items, boolean animated);
    /**
    ...
    @Bridge(symbol = "objc_msgSendSuper") private native static void objc_setRightBarButtonItemSuper(ObjCSuper __super__, Selector __cmd__, UIBarButtonItem item, boolean animated);
    /**
    ...
    @Bridge(symbol = "objc_msgSendSuper") private native static void objc_setRightBarButtonItemsSuper(ObjCSuper __super__, Selector __cmd__, NSArray items, boolean animated);
    /**
