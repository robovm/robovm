...
@Marshalers({
    ...
    @Marshaler(type = Struct[][].class, value = BuiltinMarshalers.Arrays.StructArrayMarshaler.class),
    @Marshaler(type = Struct[][][].class, value = BuiltinMarshalers.Arrays.StructArrayMarshaler.class),
    @Marshaler(type = ByteBuffer.class, value = BuiltinMarshalers.Arrays.BufferMarshaler.class),
    @Marshaler(type = ShortBuffer.class, value = BuiltinMarshalers.Arrays.BufferMarshaler.class),
    @Marshaler(type = CharBuffer.class, value = BuiltinMarshalers.Arrays.BufferMarshaler.class),
    @Marshaler(type = IntBuffer.class, value = BuiltinMarshalers.Arrays.BufferMarshaler.class),
    @Marshaler(type = LongBuffer.class, value = BuiltinMarshalers.Arrays.BufferMarshaler.class),
    @Marshaler(type = FloatBuffer.class, value = BuiltinMarshalers.Arrays.BufferMarshaler.class),
    @Marshaler(type = DoubleBuffer.class, value = BuiltinMarshalers.Arrays.BufferMarshaler.class),
})
