...
/**
 * Will modify cache and tmpdir paths given a {@link Config#builder()} and
 * prun the cache if necessary.
 * @author badlogic
 *
 */
public class RamDiskTools {
    ...
    /**
     * Checks if a RAM disk is available, pruns it if necessary
     * and rewires the {@link Builder} accordingly.
     * @param builder
     */
