...
/*<visibility>*/public/*</visibility>*/ class /*<name>*/CMStepCounter/*</name>*/ 
    ...
    public native void queryStepCount(NSDate start, NSDate end, NSOperationQueue queue, @Block VoidBlock2<Long, NSError> handler);
    @Method(selector = "startStepCountingUpdatesToQueue:updateOn:withHandler:")
    public native void startStepCountingUpdates(NSOperationQueue queue, @MachineSizedSInt long stepCounts, @Block VoidBlock3<Long, NSDate, NSError> handler);
