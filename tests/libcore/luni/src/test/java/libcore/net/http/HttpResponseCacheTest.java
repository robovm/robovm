...
public final class HttpResponseCacheTest extends TestCase {
    ...
    private void assertCached(boolean shouldPut, int responseCode) throws Exception {
        // RoboVM note: Modified to not leak MockWebServer instances (used to overwrite this.server)  
        ...
        server2.shutdown(); // tearDown() isn't sufficient; this test starts multiple servers
        }
    }
