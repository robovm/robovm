...
@NativeClass public class /*<name>*/ UIPanGestureRecognizer /*</name>*/ 
    ...
    @Bridge(symbol = "objc_msgSendSuper") private native static int objc_getMaximumNumberOfTouchesSuper(ObjCSuper __super__, Selector __cmd__);
    /**
    ...
    @Bridge(symbol = "objc_msgSendSuper") private native static int objc_getMinimumNumberOfTouchesSuper(ObjCSuper __super__, Selector __cmd__);
    /**
    ...
    @Bridge(symbol = "objc_msgSend") private native static void objc_setTranslation(UIPanGestureRecognizer __self__, Selector __cmd__, @ByVal CGPoint translation, UIView view);
    @Bridge(symbol = "objc_msgSendSuper") private native static void objc_setTranslationSuper(ObjCSuper __super__, Selector __cmd__, @ByVal CGPoint translation, UIView view);
    /**
