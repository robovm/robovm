...
/*<visibility>*/public/*</visibility>*/ class /*<name>*/ALAssetsGroup/*</name>*/ 
    ...
    public native void enumerateAssets(@Block VoidBlock2<ALAssetsGroup, Boolean> enumerationBlock);
    @Method(selector = "enumerateAssetsWithOptions:usingBlock:")
    public native void enumerateAssets(NSEnumerationOptions options, @Block VoidBlock2<ALAssetsGroup, Boolean> enumerationBlock);
    @Method(selector = "enumerateAssetsAtIndexes:options:usingBlock:")
    public native void enumerateAssets(NSIndexSet indexSet, NSEnumerationOptions options, @Block VoidBlock2<ALAssetsGroup, Boolean> enumerationBlock);
    /**
     * @since Available in iOS 5.0 and later.
     */
